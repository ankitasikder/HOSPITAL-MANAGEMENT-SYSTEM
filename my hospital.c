    ...
    void new_rec()
{
   system("color e");
    ...
    scanf("%lf",&add.phone);
    printf("\nEnter the amount to admission & book a bed :-  rs:");
    scanf("%f",&add.amt);
...
int n1;
  ...
  if(n1==1)
   ...
   void d_a_diag_report()
    ...
    scanf("%d",&chk.id_no);
    while(fscanf(ptrda,"%d %s %d/%d/%d %d %s %s %lf %s %f %d/%d/%d\n",&d_a.id_no,d_a.name,&d_a.doa.month,&d_a.doa.day,&d_a.doa.year,&d_a.ward_no,d_a.disease,d_a.symtoms,&d_a.bed_no,d_a.treatment,&d_a.tamt,&d_a.doda.month,&d_a.doda.day,&d_a.doda.year)!=EOF)
    {
    ...
    d_a.id_no=chk.id_no;
     printf("\n\n\nEnter today's date(mm/dd/yyyy):");
    scanf("%d/%d/%d",&d_a.doda.month,&d_a.doda.day,&d_a.doda.year);
    printf("\nEnter the name of patient : ");
    scanf("%s",d_a.name);
    printf("\nEnter the date of Admit (mm/dd/yyyy): ");
    scanf("%d/%d/%d",&d_a.doa.month,&d_a.doa.day,&d_a.doa.year);
    printf("\nEnter the ward no: ");
    scanf("%d",&d_a.ward_no);
    printf("\nEnter the disease: ");
    scanf("%s",d_a.disease);
    ...
    scanf("%lf",&d_a.bed_no);
    printf("\nEnter the total amount for treatment :--> rs:");
    scanf("%f",&d_a.tamt);
    printf("\n\nDETAILS OF TREATMENT(Don't use any space,you can use '-'or '_') :: ");
    scanf("%s",d_a.treatment);

        fprintf(ptrda,"%d %s %d/%d/%d %d %s %s %lf %s %f %d/%d/%d\n",d_a.id_no,d_a.name,d_a.doa.month,d_a.doa.day,d_a.doa.year,d_a.ward_no,d_a.disease,d_a.symtoms,d_a.bed_no,d_a.treatment,d_a.tamt,d_a.doda.month,d_a.doda.day,d_a.doda.year);
...
chk.id_no=comid;
        ...
        while (fscanf(ptrda,"%d %s %d/%d/%d %d %s %s %lf %s %f %d/%d/%d",&d_a.id_no,d_a.name,&d_a.doa.month,&d_a.doa.day,&d_a.doa.year,&d_a.ward_no,d_a.disease,d_a.symtoms,&d_a.bed_no,d_a.treatment,&d_a.tamt,&d_a.doda.month,&d_a.doda.day,&d_a.doda.year)!=EOF)
        {
            ...
            printf("\n\n#################################################################################\n\n");
                ...
                printf("\n\nWard no : %d \nDisease : %s \nSymtoms: %s \nBed number:%.0lf \n\n\nTreatment: %s \nTotal Treatment Cost : rs: %.2f \nDate Of Adding This Diagnostic Report : %d/%d/%d\n\n",d_a.ward_no,d_a.disease,d_a.symtoms,d_a.bed_no,
                d_a.treatment,d_a.tamt,d_a.doda.month,d_a.doda.day,d_a.doda.year);
            printf("\n\n#################################################################################\n\n");
                                 add_invalid7:
...
if(test==0)
{
    printf("\n\n\nSorry,Patient record is not found.....................\n\nTry again later..");
      add_invalid3:
    printf("\n\n\n\t\tEnter 1 to try again  and 0 to main menu:");
    scanf("%d",&main_exit);
    system("cls");
    ...
    printf("Enter the ID number:");
        ...
        while (fscanf(ptrda,"%d %s %d/%d/%d %d %s %s %lf %s %f %d/%d/%d",&d_a.id_no,d_a.name,&d_a.doa.month,&d_a.doa.day,&d_a.doa.year,&d_a.ward_no,d_a.disease,d_a.symtoms,&d_a.bed_no,d_a.treatment,&d_a.tamt,&d_a.doda.month,&d_a.doda.day,&d_a.doda.year)!=EOF)
        {
            ...
            {   system("cls");
                ...
                printf("\nID_NO.: %d\nName: %s \nDate of Admit: %d/%d/%d \nWard no : %d \nDisease : %s \nSymtoms: %s \nBed number:%.0lf \n\n\nTreatment: %s \nTotal Treatment Cost : rs: %.2f \nDate Of Adding This Diagnostic Report : %d/%d/%d\n\n",d_a.id_no,d_a.name,d_a.doa.month,d_a.doa.day,d_a.doa.year,d_a.ward_no,d_a.disease,d_a.symtoms,d_a.bed_no,
                d_a.treatment,d_a.tamt,d_a.doda.month,d_a.doda.day,d_a.doda.year);
                      add_invalid5:
    printf("\n\n\n\t\tEnter 1 to try again  and 0 to main menu:");
    scanf("%d",&main_exit);
